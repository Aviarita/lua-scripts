...
local function disable_visuals_effects()
	...
	local transparent_walls = ref("VISUALS", "Effects", "Transparent walls") set(transparent_walls, 1) vis(transparent_walls)
	local transparent_props = ref("VISUALS", "Effects", "Transparent props") set(transparent_props, 1) vis(transparent_props)
